...
/// will be included in the next block right after sending.  FIXME: 15 secs probably not correct on RSK
pub const RSK_CONFIRMATION_TIMEOUT: Duration = Duration::from_secs(300);
