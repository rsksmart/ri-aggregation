...
import { Wallet, types, Create2WalletSigner, Transaction } from '@rsksmart/rif-rollup-js-sdk';
...
import { HTTPTransport } from '@rsksmart/rif-rollup-js-sdk/build/transport';
