import { Wallet as RollupWallet, RootstockOperation, Transaction } from '@rsksmart/rif-rollup-js-sdk';
...
export { prepareWithdrawal, generateWithdrawals, executeWithdrawals, resolveTransactions as resolveWithdrawTransactions };
